...
1. Download the template:
        ...
        git clone git://github.com/cogfor/scala-sbt-template.git
        
     Or, if you don't have git installed, download and unzip the files manually from [here](https://github.com/cogfor/scala-sbt-template/downloads).
